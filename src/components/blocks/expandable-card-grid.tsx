...
export default function ExpandableCardDemo(
  ...
  return (
    <section {...{ className }}> 
              ...
              <div>
                ...
                <div className="pt-4 relative px-4">
                  <motion.div
                    ...
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                    className="text-white text-xs md:text-sm lg:text-base h-40 md:h-fit pb-10 flex flex-col items-start gap-4 overflow-auto dark:text-neutral-400 [mask:linear-gradient(to_bottom,white,white,transparent)] [scrollbar-width:none] [-ms-overflow-style:scroll] [-webkit-overflow-scrolling:touch]"
                  >
      ...
      <ul className="max-w-3xl mx-auto w-full grid grid-cols-1 md:grid-cols- lg:grid-cols-3 items-start gap-4 pt-10">
        {cards.map((card) => (
          <motion.div
            ...
            <div className="flex gap-4 flex-col  w-full">
              <motion.div layoutId={`image-${card.title}-${id}`}>
                <Image
                  ...
                  src={card.src}
                  alt={card.title}
                  className={`${card.contain ? "object-contain" : "object-cover"} h-60 w-full rounded-lg object-center object-top`}
                />
              </motion.div>
